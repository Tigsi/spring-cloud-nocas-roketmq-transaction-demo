package com.wss.service.product.service.mq;

import com.alibaba.fastjson.JSONObject;
import com.wss.service.product.config.Jms;
...
public class OrderConsumer {
	...
	public OrderConsumer(@Autowired Jms jms, @Autowired ProductService productService) throws MQClientException {
		//设置消费组
		...
		consumer.registerMessageListener((MessageListenerConcurrently) (msgs, context) -> {
			...
			try {
				productService.updateStore(productId, total, key);
